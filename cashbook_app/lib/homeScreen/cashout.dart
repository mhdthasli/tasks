  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Cash out",style: TextStyle(color: Color(0xFFFFFFFF),),),
        leading: InkWell(
          onTap: (){
                ...
                Row(
                  ...
                  children: [
                    ToggleButtons(
                      ...
                      fillColor: Color(0xFF3A4A3D),
                      borderColor: Colors.black,
                      isSelected: [isCashOut, !isCashOut],
                      onPressed: (index){
                        setState(() {
                          isCashOut = index ==0;
                        },
                          ...
                          child: TextFormField(
                            decoration: InputDecoration(
                              ...
                              focusedBorder: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(10),
                                borderSide:
                                const BorderSide(color: Color(0xFF3A4A3D)),
                              ),
                              enabledBorder: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(10),
                                borderSide: const BorderSide(color: Colors.black),
